...
execute as @e[type=skeleton,tag=sun_g,tag=sunmoon4] at @s run function core:scene/sunmoon/indv_despawn4
execute as @e[type=phantom,tag=sun_g_mount,tag=sunmoon4] at @s run data merge entity @s {DeathTime:19s,Health:0.0f}
execute as @e[type=zombie,tag=moon_g,tag=sunmoon4] at @s run function core:scene/sunmoon/indv_despawn4
