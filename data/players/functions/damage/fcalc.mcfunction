...
scoreboard players reset #fire_prot_total temp
scoreboard players reset #fire_prot_temp temp
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:fire_protection"}].lvl 8
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"fire_protection"}].lvl 8
scoreboard players operation #fire_prot_total temp = #fire_prot_temp temp
scoreboard players reset #fire_prot_temp temp
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:fire_protection"}].lvl 8
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"fire_protection"}].lvl 8
scoreboard players operation #fire_prot_total temp += #fire_prot_temp temp
scoreboard players reset #fire_prot_temp temp
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:fire_protection"}].lvl 8
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"fire_protection"}].lvl 8
scoreboard players operation #fire_prot_total temp += #fire_prot_temp temp
scoreboard players reset #fire_prot_temp temp
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:fire_protection"}].lvl 8
execute store result score #fire_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"fire_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"fire_protection"}].lvl 8
scoreboard players operation #fire_prot_total temp += #fire_prot_temp temp

execute if score #fire_prot_total temp matches 81.. run scoreboard players set #fire_prot_total temp 80
...
scoreboard players operation #prot_reduce temp -= #fire_prot_total temp
