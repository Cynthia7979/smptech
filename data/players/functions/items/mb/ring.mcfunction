...
function core:rng
scoreboard players operation #rand temp %= #36000 const
execute store result storage drehmal:entities tempRot[1] float 0.0075 run scoreboard players remove #rand temp 18000
execute as @e[type=marker,tag=special] run function players:items/mb/ring2