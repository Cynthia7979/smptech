...
execute if score #rand temp matches 4 if predicate entities:spawn_checks/3x3x3 run scoreboard players add #spawnedTotal num 1
execute if score #rand temp matches 4 if predicate entities:spawn_checks/3x3x3 run summon magma_cube ~ ~ ~ {Size:3}
...
execute if score #step num matches ..11 unless score #spawnedTotal num >= #packCap num at @s run function entities:spawn/lodahr_cycle/checks/vanilla/magma_cube