...
data modify storage drehmal:players tempItem set from storage drehmal:players tempPlayer.Inventory[{Slot:5b}]
...
item replace entity @s container.5 from block 1000000 0 1000000 container.0