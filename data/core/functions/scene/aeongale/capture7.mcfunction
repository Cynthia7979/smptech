...
execute if score #aeoncap1 x matches 600.. run setblock 1026 24 1266 sea_lantern
execute if score #aeoncap1 x matches 600.. run setblock 1033 43 1219 shroomlight
...
execute if score #aeoncap1 x matches 600.. run scoreboard players set #aeongale x 7
