...
data modify storage drehmal:players tempItem set from storage drehmal:players tempPlayer.Inventory[{Slot:4b}]
...
item replace entity @s container.4 from block 1000000 0 1000000 container.0