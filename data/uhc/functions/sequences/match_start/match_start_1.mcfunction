function uhc:spawning/shuffle_towers
execute positioned 26520 178 -137 run function uhc:spawning/spread_players
...
title @a title {"text":"3","bold":true,"color":"red"}
schedule function uhc:sequences/match_start/match_start_2 1s
schedule function uhc:sequences/match_start/match_start_3 2s
schedule function uhc:sequences/match_start/match_start_4 3s