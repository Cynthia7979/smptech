...
data modify storage drehmal:players tempItem set from storage drehmal:players tempPlayer.Inventory[{Slot:17b}]
...
item replace entity @s container.17 from block 1000000 0 1000000 container.0