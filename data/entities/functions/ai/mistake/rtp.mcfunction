...
execute store result score #temp y run data get storage drehmal:entities tempPos2[1]
execute store result storage drehmal:entities tempPos2[1] double 1 run scoreboard players get #temp y
...
execute if score #improper? temp matches 1 run function entities:ai/mistake/rtp_loop