...
execute if score wave_time foundry matches 0..200 if score base_mob_count foundry matches 1..10 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_base
execute if score wave_time foundry matches 0..200 if score unstable_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_unstable
execute if score wave_time foundry matches 0..200 if score heavy_mob_count foundry matches 0 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_heavy
execute if score wave_time foundry matches 0..200 if score contaminated_mob_count foundry matches 0 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_contaminated
execute if score wave_time foundry matches 0..200 if score agility_mob_count foundry matches 0 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_agility
