...
execute if score #aeoncap1 x matches 600.. run setblock 867 31 1167 sea_lantern
execute if score #aeoncap1 x matches 600.. run setblock 887 36 1200 shroomlight
...
execute if score #aeoncap1 x matches 600.. run scoreboard players set #aeongale x 1
