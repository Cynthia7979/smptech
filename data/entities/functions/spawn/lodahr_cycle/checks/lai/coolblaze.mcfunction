...
execute if predicate entities:spawn_checks/1x1x2 run function entities:spawn/coolblaze
...
execute if score #step num matches ..11 unless score #spawnedTotal num >= #packCap num at @s run function entities:spawn/lodahr_cycle/checks/lai/coolblaze