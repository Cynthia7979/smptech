...
execute if score #type temp matches 1 at @s run summon marker ~ ~ ~ {Tags:["mob2_drowned_spawner","bernice_spawner"]}
execute if score #type temp matches 2 at @s run summon marker ~ ~ ~ {Tags:["mob2_guardian_spawner","bernice_spawner"]}
execute if score #type temp matches 3 at @s run summon marker ~ ~ ~ {Tags:["mob2_eguardian_spawner","bernice_spawner"]}
execute if score #loop temp matches 1.. run function entities:ai/worm/mob2/rng_spread