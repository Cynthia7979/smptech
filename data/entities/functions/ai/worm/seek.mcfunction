execute if score @s seek_timer matches ..0 anchored eyes facing entity @p eyes positioned ^ ^ ^0.3 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
execute unless score @s seek_timer matches ..0 anchored eyes facing entity @p eyes positioned ^ ^ ^0.05 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
