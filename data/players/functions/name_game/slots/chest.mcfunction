...
data modify storage drehmal:players tempItem set from storage drehmal:players tempPlayer.Inventory[{Slot:102b}]
...
item replace entity @s armor.chest from block 1000000 0 1000000 container.0