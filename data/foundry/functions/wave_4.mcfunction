...
execute if score wave_time foundry matches 0..200 if score base_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_base
...
execute if score wave_time foundry matches 0..200 if score primal_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_primal
...
execute if score wave_time foundry matches 200..220 if score base_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s run function foundry:mobs/spawn_base
...
execute if score wave_time foundry matches 200..220 if score primal_mob_count foundry matches 1..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_primal
