...
execute if score wave_time foundry matches 0..200 if score base_mob_count foundry matches 1..8 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_base
...
execute if score wave_time foundry matches 0..200 if score agility_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_agility

execute if score wave_time foundry matches 0..70 if score sentry_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 140..210 if score sentry_mob_count foundry matches 3..3 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 270..340 if score sentry_mob_count foundry matches 4..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
...
execute if score wave_time foundry matches 200..220 if score agility_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s run function foundry:mobs/spawn_agility

execute if score wave_time foundry matches 70..90 if score sentry_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 210..230 if score sentry_mob_count foundry matches 3..3 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 340..360 if score sentry_mob_count foundry matches 4..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_sentry
