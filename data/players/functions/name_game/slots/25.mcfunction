...
data modify storage drehmal:players tempItem set from storage drehmal:players tempPlayer.Inventory[{Slot:25b}]
...
item replace entity @s container.25 from block 1000000 0 1000000 container.0