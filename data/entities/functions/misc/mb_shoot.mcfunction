...
summon marker ~ ~ ~ {Tags:["special","enemy_proj","mb_run_laser","fancy","pierce","accelerate_nl","no_snow_c"]}
...
execute as @e[type=marker,tag=special] run function entities:misc/mb_stats
