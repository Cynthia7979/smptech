...
execute store result score #slot temp run data get storage drehmal:players tempList[0].Slot
data remove storage drehmal:players tempList[0].Slot
data remove storage drehmal:players tempList[0].tag.Enchantments[{id:"minecraft:sharpness",lvl:25s}]
data remove storage drehmal:players tempList[0].tag.mod_proxigea
