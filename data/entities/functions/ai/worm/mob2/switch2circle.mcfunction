...
function entities:ai/worm/lasers/shapes/small_cube
...
execute as @e[type=marker,tag=special] at @s run function entities:ai/worm/mob2/rng_spread
...
scoreboard players set #type temp 3
