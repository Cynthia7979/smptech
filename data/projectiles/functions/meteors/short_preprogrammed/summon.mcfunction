...
execute as @p if predicate players:sim_distance align xyz positioned ~0.5 ~ ~0.5 run function projectiles:meteors/short_preprogrammed/check
...
execute if score #tmp temp matches 1 as @e[tag=aph_meteor_spawn] at @s run function projectiles:meteors/short_preprogrammed/run_summon