scoreboard players reset #core_ani timer
scoreboard players set #mrun_trig bool 1
scoreboard players set #no_c_m? bool 1
scoreboard players reset #cmtrig2 bool
scoreboard players reset #cmtrig3 bool
scoreboard players set #core_broke bool 1
...
execute positioned 27304 122 55 as @a[distance=..100] run function core:scene/mb/ani_damage
