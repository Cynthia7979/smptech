...
execute if predicate entities:spawn_checks/1x1x2 run function entities:spawn/khive_zombie
...
execute if score #step num matches ..11 unless score #spawnedTotal num >= #packCap num at @s run function entities:spawn/lodahr_cycle/checks/khive/khive_zombie
