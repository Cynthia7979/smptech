...
scoreboard players reset #blast_prot_total temp
scoreboard players reset #blast_prot_temp temp
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl 8
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:103b}].tag.Enchantments[{id:"blast_protection"}].lvl 8
scoreboard players operation #blast_prot_total temp = #blast_prot_temp temp
scoreboard players reset #blast_prot_temp temp
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl 8
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:102b}].tag.Enchantments[{id:"blast_protection"}].lvl 8
scoreboard players operation #blast_prot_total temp += #blast_prot_temp temp
scoreboard players reset #blast_prot_temp temp
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl 8
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:101b}].tag.Enchantments[{id:"blast_protection"}].lvl 8
scoreboard players operation #blast_prot_total temp += #blast_prot_temp temp
scoreboard players reset #blast_prot_temp temp
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"minecraft:blast_protection"}].lvl 8
execute store result score #blast_prot_temp temp if data storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"blast_protection"}] run data get storage drehmal:players tempPlayer.Inventory[{Slot:100b}].tag.Enchantments[{id:"blast_protection"}].lvl 8
scoreboard players operation #blast_prot_total temp += #blast_prot_temp temp

execute if score #blast_prot_total temp matches 81.. run scoreboard players set #blast_prot_total temp 80
...
scoreboard players operation #prot_reduce temp -= #blast_prot_total temp
