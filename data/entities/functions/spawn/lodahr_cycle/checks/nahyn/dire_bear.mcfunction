...
execute if predicate entities:spawn_checks/2x2x2 positioned ~0.5 ~ ~0.5 run function entities:spawn/dire_bear
...
execute if score #step num matches ..11 unless score #spawnedTotal num >= #packCap num at @s run function entities:spawn/lodahr_cycle/checks/nahyn/dire_bear