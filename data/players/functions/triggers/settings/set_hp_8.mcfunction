scoreboard players set playercount playercount 8
scoreboard players set #auto_scale? const 0
function players:triggers/settings_display
tag @s add temp_nodisp
tellraw @a[tag=!temp_nodisp] ["",{"text":"Player health and damage scaling reconfigured for ","color":"gray"},{"text":"8+ ","bold":true,"color":"gold"},{"text":"players.","color":"gray"}]
