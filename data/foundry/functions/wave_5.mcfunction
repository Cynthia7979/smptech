...
execute if score wave_time foundry matches 0..200 if score heavy_mob_count foundry matches 1..3 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_heavy
...
execute if score wave_time foundry matches 800..1000 if score agility_mob_count foundry matches 3..4 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_agility

execute if score wave_time foundry matches 0..300 if score sentry_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 600..900 if score sentry_mob_count foundry matches 3..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 0..200 if score primal_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_primal
...
execute if score wave_time foundry matches 1200..1400 if score chemistry_mob_count foundry matches 4..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_chemistry

execute if score wave_time foundry matches 0..200 if score superheavy_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_superheavy
...
#execute if score wave_time foundry matches 6000..6200 if score technomancer_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s unless entity @a[distance=..4] run function foundry:mobs/spawn_technomancer
...
execute if score wave_time foundry matches 200..220 if score heavy_mob_count foundry matches 1..3 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s run function foundry:mobs/spawn_heavy
...
execute if score wave_time foundry matches 1000..1020 if score agility_mob_count foundry matches 3..4 as @e[type=area_effect_cloud,tag=foundry_fodder,sort=random,limit=1] at @s run function foundry:mobs/spawn_agility

execute if score wave_time foundry matches 300..320 if score sentry_mob_count foundry matches 1..2 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_sentry
execute if score wave_time foundry matches 900..920 if score sentry_mob_count foundry matches 3..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_sentry
...
execute if score wave_time foundry matches 1400..1420 if score chemistry_mob_count foundry matches 4..4 as @e[type=area_effect_cloud,tag=foundry_ranged,sort=random,limit=1] at @s run function foundry:mobs/spawn_chemistry

execute if score wave_time foundry matches 200..220 if score superheavy_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s run function foundry:mobs/spawn_superheavy
...
#execute if score wave_time foundry matches 6200..6220 if score technomancer_mob_count foundry matches 1..1 as @e[type=area_effect_cloud,tag=foundry_elite,sort=random,limit=1] at @s run function foundry:mobs/spawn_technomancer
