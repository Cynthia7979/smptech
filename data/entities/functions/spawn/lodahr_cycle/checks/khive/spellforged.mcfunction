...
execute if predicate entities:spawn_checks/3x3x3 run function entities:spawn/mistake
...
execute if score #step num matches ..11 unless score #spawnedTotal num >= #packCap num at @s run function entities:spawn/lodahr_cycle/checks/khive/spellforged
