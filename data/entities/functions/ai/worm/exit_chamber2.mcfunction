execute anchored eyes facing -378 23 553 positioned ^ ^ ^1.5 rotated as @s positioned ^ ^ ^5 facing entity @s eyes facing ^ ^ ^-1 positioned as @s run tp @s ~ ~ ~ ~ ~
...
execute positioned -378 23 553 if entity @s[distance=..2] run function entities:ai/worm/phases/chamber_exited2