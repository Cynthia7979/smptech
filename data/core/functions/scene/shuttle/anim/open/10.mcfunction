...
#execute in minecraft:space positioned -182.00 132.40 189.77 run playsound minecraft:dcustom.entity.iron_golem.hurt block @a[distance=..200] ~ ~ ~ 100 1.8

function core:scene/shuttle/anim/door/10